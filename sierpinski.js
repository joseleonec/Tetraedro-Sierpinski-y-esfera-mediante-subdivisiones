function increment() {
    ...
    depth = document.getElementById('demoInput').value;
    startSierpinski(document.getElementById("sierpinski"), depth);
}
function decrement() {
...
var startSierpinski = function (canvas, depth) {
    document.getElementById('demoInput').addEventListener("click", increment);
    ...
    divideTetrahedron(vertices, normals,
        ...
        depth);
    //divideTetrahedron(vertices, normals,[0,5,0],[-5,-5,-5],[-5,-5,5],[5,-5,0],depth);
